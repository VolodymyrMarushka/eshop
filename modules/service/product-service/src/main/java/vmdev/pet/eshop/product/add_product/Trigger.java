...
public class Trigger {
  ...
  static class Web {
    ...
    @PostMapping(path = "/product/add", consumes = MediaType.APPLICATION_JSON_VALUE, produces =
        MediaType.APPLICATION_JSON_VALUE)
    @ValidateRequest("/vmdev/pet/eshop/product/add_product/request_schema.json")
